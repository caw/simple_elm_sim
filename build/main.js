...
var author$project$Circ$secondsInMinute = 60.0;
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Run':
				...
				var newSim = _Utils_update(
					sim,
					{runningState: author$project$Main$Running});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{sim: newSim}),
			...
			case 'Pause':
				...
				var newSim = _Utils_update(
					sim,
					{runningState: author$project$Main$Paused});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{sim: newSim}),
			...
			default:
				...
				var newSim = _Utils_update(
					sim,
					{runningState: author$project$Main$Finished});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{sim: newSim}),
...
var author$project$Main$RunButton = {$: 'RunButton'};
var author$project$Main$btnState = F2(
	function (btn, model) {
		var state = model.sim.runningState;
		switch (btn.$) {
			case 'RunButton':
				return _Utils_eq(state, author$project$Main$Running) || _Utils_eq(state, author$project$Main$Finished);
			case 'PauseButton':
				return _Utils_eq(state, author$project$Main$NotStarted) || (_Utils_eq(state, author$project$Main$Finished) || _Utils_eq(state, author$project$Main$Paused));
			default:
